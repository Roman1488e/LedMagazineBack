...
namespace LedMagazineBack.Migrations
{
    ...
    public partial class main_migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RentTimesMultiplayer",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SecondsDifferenceMultiplayer = table.Column<float>(type: "real", nullable: false),
                    MonthsDifferenceMultiplayer = table.Column<float>(type: "real", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentTimesMultiplayer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RentTimesMultiplayer_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScreenSpecifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScreenSpecifications_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RentSeconds = table.Column<byte>(type: "smallint", nullable: false),
                    RentMonths = table.Column<byte>(type: "smallint", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndOfRentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CartItemId = table.Column<Guid>(type: "uuid", nullable: true),
                    OrderItemId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentTimes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentTimesMultiplayer_ProductId",
                table: "RentTimesMultiplayer",
                column: "ProductId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ScreenSpecifications_ProductId",
                table: "ScreenSpecifications",
                column: "ProductId",
                unique: true);
        }
